...
type GreetServiceClient interface {
	...
	SayHelloServerStreaming(ctx context.Context, in *ListNames, opts ...grpc.CallOption) (GreetService_SayHelloServerStreamingClient, error)
...
func (c *greetServiceClient) SayHelloServerStreaming(ctx context.Context, in *ListNames, opts ...grpc.CallOption) (GreetService_SayHelloServerStreamingClient, error) {
...
type GreetServiceServer interface {
	...
	// Server Streaming RPC
	SayHelloServerStreaming(*ListNames, GreetService_SayHelloServerStreamingServer) error
	// Client Streaming RPC
...
func (UnimplementedGreetServiceServer) SayHelloServerStreaming(*ListNames, GreetService_SayHelloServerStreamingServer) error {
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/greetService.proto",
}
